...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    //let transtactionObjArr = getTransactionsFromApi();
    //mostrarEnPantallaArrayDeTransacciones(transtactionObjArr)
...
function mostrarEnPantallaArrayDeTransacciones(transactionObjArr) {
    transactionObjArr.forEach(transactionElement => { insertRowinTransactionTable(transactionElement) });
}
